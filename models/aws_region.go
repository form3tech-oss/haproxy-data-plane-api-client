...
// Example: {"access_key_id":"****************L7GT","allowlist":[{"key":"tag-key","value":"Instance:Having:This:Tag"}],"denylist":[{"key":"tag:Environment","value":"development"}],"enabled":true,"id":0,"ipv4_address":"private","name":"frontend-service","region":"us-east-1","secret_access_key":"****************soLl"}
//
